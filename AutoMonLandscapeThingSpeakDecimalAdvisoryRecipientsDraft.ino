//   AutoMonLandscapeThingSpeakDecimalAdvisoryRecipientsDraft
//Date Modified & Created: 8 May 2024 From Sketch AutoMonLandscapeThingSpeakSeparateFieldsDraft
//Dates Revised: May 10, 2024
//Goals: Similar advisory message to the Field Scale Version(8May2024); Have a decimal place reflected in ThingSpeak for the battery level; Multiple recipients (8May2024)
//Progress Made: Improved the SMS with irrigation and battery advisories (8May2024); bugs found in advisory conditionals that need fixing (10May2024)
...
int waterL = 130;     // An int variable
int *ptr = &waterL;  // A pointer variable, with the name ptr, that stores the address of myAge
...
//    spiuart.println("Water Level, Battery Level, Node ID:");//12 March 2024 to add SMS description to sensor data
  ...
  //  Serial.print("The pointer value is %p\n", a); //(12April2024)
   // spiuart.print("The pointer value is %p\n", a); //(12April2024)
    ...
    Serial.print("The AutoMon Landscape Node ID is: "); //( Single Data - Node ID, 11April2024)
    spiuart.println ("The AutoMon Landscape Node ID is: ");//( Single Data - Node ID, 11April2024)
    delay(1000);   
    Serial.print(buf3); //(11April2024)
    spiuart.print(buf3); //(11April2024)

    Serial.print("The water level in mm from the soil surface is: "); //( Single Data - WL, 8April2024)
    spiuart.println ("The water level in mm from the soil surface is: ");//( Single Data - WL, 8April2024)
    delay(1000);   
    ...
    Serial.print("Irrigate if it is equal or deeper than -130. "); //21May2024
    spiuart.println ("Irrigate if it is equal or deeper than -130. "); //21May2024


//    //bugs found in the conditionals as of 10 May 2024
//    if ((int)buf1 < 0)
//    {
//    Serial.print("It is negative"); 
//    spiuart.println ("It is negative ");
//    }
//    else if ((int)buf1 >= 0) 
//    {
//    Serial.print("It is positive "); 
//    spiuart.println ("It is positive");      
//    }

  
    Serial.print("The remaining battery level in volts is: "); //( Single Data - WL, 11April2024)
    spiuart.println ("The remaining battery level in volts is: ");//( Single Data - WL, 11April2024)
    Serial.print(buf2);
    spiuart.print(buf2);
    int y = atof (buf2); //converting char buf1 to float for ThingSpeak access 12April2024

    Serial.print("Replace the battery if it is equal or lower than 3.5"); //21May2024
    spiuart.println ("Replace the battery if it is equal or lower than 3.5"); //21May2024


    //      if ((int)buf2 > 3.6)
//    {
//    Serial.print("You do not need to check & recharge! "); 
//    spiuart.println ("You do not need to check & recharge! ");
//    }
//    else if ((int)buf2 < 3.6) 
//    {
//    Serial.print("You need to check & recharge! "); 
//    spiuart.println ("You need to check & recharge! ");      
//    }
...
//   spiuart.println(str);
  ...
  //String str1="GET https://api.thingspeak.com/update?api_key=43GYIJ1GJN55CBKP&field1=" + String(buf1)+"&field2="+ String(buf2); //11April2024
   ...
   String str="GET https://api.thingspeak.com/update?api_key=AIL624TJ77HUP0U8&field1=" + String(x)+"&field2="+ String(y)+"&field3="+ String(buf3); //15April 2024 removed the placement holder z
   //String str="GET https://api.thingspeak.com/update?api_key=AIL624TJ77HUP0U8&field1=" + String(buf2)+"&field2="+ String(buf3);
   Serial.println(str);
   spiuart.println(str);
   delay(4000);
